...
class ModelServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetModels = channel.unary_unary(
                '/mlservice.ModelService/GetModels',
                request_serializer=service__pb2.Empty.SerializeToString,
                response_deserializer=service__pb2.ModelList.FromString,
                _registered_method=True)
        ...
        self.RetrainModel = channel.unary_unary(
                '/mlservice.ModelService/RetrainModel',
        ...
        self.CheckStatus = channel.unary_unary(
                '/mlservice.ModelService/CheckStatus',
                request_serializer=service__pb2.Empty.SerializeToString,
...
def add_ModelServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetModels': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=service__pb2.ModelList.SerializeToString,
            ),
...
class ModelService(object):
    ...
    def GetModels(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            service__pb2.ModelList.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
